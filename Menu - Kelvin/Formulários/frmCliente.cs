        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            switch (keyData)
            {
                case Keys.F1:
                    if (cbDatas.Checked)
                    {
                        DB.SelecionaCliente(dgCliente, cbTodosClientes);
                    }
                    else
                    {
                        DB.SelecionaCliente(dgCliente, cbTodosClientes, dtpInicial, dtpFinal);
                    }
                    break;
                case Keys.F2:
